<?php
	...
	$moxieManagerConfig['filesystem.rootpath'] = '/var/www/vhosts/cvscreen.co.uk/public_html';
	...
	// Local filesystem
	$moxieManagerConfig['filesystem.local.wwwroot'] = '/var/www/vhosts/cvscreen.co.uk/public_html';
	...
	$moxieManagerConfig['log.path'] = '/var/www/vhosts/cvscreen.co.uk/public_html/logs';
	...
	$moxieManagerConfig['storage.path'] = '/var/www/vhosts/cvscreen.co.uk/public_html';
