				...
				<ul class="nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="pages.php">Web Pages</a></li>
							<li><a href="notification.php">Website Search Results</a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="key_phrases.php">Phrases for Jobs</a></li>
							<li><a href="jobs.php">Vacancies</a></li>
						</ul>
					</li>
					<li class="dropdown">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="meta_data_list.php">Global Metadata Editor</a></li>
