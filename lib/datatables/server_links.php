...
require_once("lib.inc.php");
	 ...
	 */
	 $aColumns = array( 'links.ID', 'sites.Name as SiteName', 'links.Label', 'links.Type', 'links.OrderNum', 'links.Modified', 'links.Active', 'links.GUID');
	 
	$aColumns1 = array( 'ID', 'SiteName', 'Label', 'Type', 'OrderNum', 'Modified', 'Active', 'GUID');
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns1) ; $i++ )
		{
			if ($aColumns1[$i] == "GUID") {
            	...
            	$row[] = strtoupper($aRow[ $aColumns1[$i] ]);
            }
